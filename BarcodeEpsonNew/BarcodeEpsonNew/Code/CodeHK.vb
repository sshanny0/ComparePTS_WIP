...
Public Class CodeHK
    ...
    End Sub
    Private Sub CodeHK_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        MainMenu.Show()
        Me.Hide()
    End Sub
    Private Sub CodeHK_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cmb_assy.Select()
        ...
        If dt3.Rows.Count > 0 Then
            ...
            Else
                For counter = Convert.ToInt32(serialcountMain + 1) To Convert.ToInt32(qty_end.Text)
                    ...
                    queryCounter &= "SELECT * FROM PCB_Prod_srno_code_y "
    ...
    Sub PrintCitizen()
        ...
        If ListView1.Items.Count > 0 Then
            ...
            Dim queryPrint As String = String.Empty
            queryPrint &= "SELECT * FROM PCB_Prod_SrNo "
            queryPrint &= "WHERE AssyNo = '" & cmb_assy_value & "' AND sqno = '" & sqnoprint & "' and rowsq = '1'"
            queryPrint &= "ORDER BY sqno DESC, rowsq ASC"
            Dim dtprint As DataTable = GetDataTDF(queryPrint)
            ...
            If LabelConst.CLS_SUCCESS = connectResult Then
                ...
                If dtprint.Rows.Count > 0 Then
                    For Each row As DataRow In dtprint.Rows
                        ...
                        design.DrawBarCode(printSrno1, LabelConst.CLS_BCS_CODE128, LabelConst.CLS_RT_NORMAL, 1, 1, 10, 20, 7, LabelConst.CLS_BCS_TEXT_HIDE)
                        ''(String data, String fontName, int rotation, int hRatio, int vRatio, Int Point, Int style, Int x, Int y, Int resolution, Int measurementUnit)
                        'design.DrawTextPCFont(printSrno1, "Libre Barcode 128", LabelConst.CLS_RT_NORMAL, 200, 150, 10, LabelConst.CLS_FNT_DEFAULT, 20, 7, LabelConst.CLS_PRT_RES_300, LabelConst.CLS_UNIT_MILLI)
