...
Public Class CodeSW
    ...
    End Sub
    Private Sub CodeSW_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        MainMenu.Show()
        Me.Hide()
    End Sub
    Private Sub CodeSW_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        cmb_assy.Select()
